...
this.BYU.oauth.implicit = (function (exports, sha256Lib) {
  'use strict';

  sha256Lib = sha256Lib && sha256Lib.hasOwnProperty('default') ? sha256Lib['default'] : sha256Lib;
  ...
  class ImplicitGrantProvider {
    ...
    startLogin(displayType = 'window') {
      ...
      const codeChallenge = btoa(String.fromCharCode(...sha256.array(codeVerifier))).replace(/\+/g, '-').replace(/\//g, '_').replace(/=/g, '');
