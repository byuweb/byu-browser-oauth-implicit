const EVENT_PREFIX="byu-browser-oauth",EVENT_STATE_CHANGE=`${"byu-browser-oauth"}-state-changed`,EVENT_LOGIN_REQUESTED=`${"byu-browser-oauth"}-login-requested`,EVENT_LOGOUT_REQUESTED=`${"byu-browser-oauth"}-logout-requested`,EVENT_REFRESH_REQUESTED=`${"byu-browser-oauth"}-refresh-requested`,EVENT_CURRENT_INFO_REQUESTED=`${"byu-browser-oauth"}-current-info-requested`,STATE_INDETERMINATE="indeterminate",STATE_UNAUTHENTICATED="unauthenticated",STATE_AUTHENTICATED="authenticated",STATE_AUTHENTICATING="authenticating",STATE_EXPIRED="expired",STATE_ERROR="error";/*
 *  @license
