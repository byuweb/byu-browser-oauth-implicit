const LEVEL_TRACE={priority:0,name:"trace",run:handleTrace},LEVEL_DEBUG={priority:1,name:"debug",run:handleDebug},LEVEL_INFO={priority:10,name:"info",run:handleInfo},LEVEL_ERROR={priority:100,name:"error",run:handleError},ALL_LEVELS=[LEVEL_TRACE,LEVEL_DEBUG,LEVEL_INFO,LEVEL_ERROR],DEFAULT_LEVEL=LEVEL_INFO;function debug(...a){doLog(LEVEL_DEBUG,...a)}function info(...a){doLog(LEVEL_INFO,...a)}function error(...a){doLog(LEVEL_ERROR,...a)}function doLog(a,...b){if(shouldLog(a)){const c=new Date().toLocaleTimeString({h12:!1});a.run("[byu-browser-oauth-implicit]",`[${a.name}]`,`(${c})`,...b)}}function shouldLog(a){return a.priority>=currentLevel().priority}function currentLevel(){const a=levelAttr()||levelGlobalVar();if(!a)return DEFAULT_LEVEL;const b=a.toLowerCase();return ALL_LEVELS.find(function(a){return a.name===b})||DEFAULT_LEVEL}function levelAttr(){return document.documentElement.getAttribute("byu-oauth-logging")}function levelGlobalVar(){const a=window.byuOAuth||{};return a.logging}function handleTrace(...a){console.trace?console.trace(...a):console.log(...a)}function handleDebug(...a){console.log(...a)}function handleInfo(...a){console.info?console.info(...a):console.log(...a)}function handleError(...a){console.error?console.error(...a):console.log(...a)}const EVENT_PREFIX="byu-browser-oauth",EVENT_STATE_CHANGE=`${"byu-browser-oauth"}-state-changed`,EVENT_LOGIN_REQUESTED=`${"byu-browser-oauth"}-login-requested`,EVENT_LOGOUT_REQUESTED=`${"byu-browser-oauth"}-logout-requested`,EVENT_REFRESH_REQUESTED=`${"byu-browser-oauth"}-refresh-requested`,EVENT_CURRENT_INFO_REQUESTED=`${"byu-browser-oauth"}-current-info-requested`,STATE_INDETERMINATE="indeterminate",STATE_UNAUTHENTICATED="unauthenticated",STATE_AUTHENTICATED="authenticated",STATE_AUTHENTICATING="authenticating",STATE_ERROR="error";/*
 *  @license
