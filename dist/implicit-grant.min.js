 ...
 */async function configure(a){const b=window[GLOBAL_CONFIG_KEY],c=Object.assign({issuer:DEFAULT_ISSUER,callbackUrl:`${location.origin}${location.pathname}`,doNotAutoRefreshOnTimeout:!1},b,a);if(!c.clientId)throw new Error("clientId must be specified in config");const d=new ImplicitGrantProvider(c,window,document);return d.startup()}export{DEFAULT_ISSUER,GLOBAL_CONFIG_KEY,configure};
